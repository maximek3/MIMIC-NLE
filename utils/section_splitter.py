# this is the section splitter code given by the mimic-cxr authors
# https://github.com/MIT-LCP/mimic-cxr/blob/31901464793d0bb23835092f05bd1aba6af7baff/txt/section_parser.py#L5
